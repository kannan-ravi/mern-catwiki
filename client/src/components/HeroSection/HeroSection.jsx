  ...
  return (
    <>
      <div className="upperHero--section__container">
        <img src={Logo} alt="Logo Image" className="upperHero--image" />
        <p className="upperHero--text">Get to know more about your cat breed</p>
        <div
          className={
            search
              ? "upperHero--form-breedName__container"
              : "upperHero--form-breedName__container-mobile"
          }
        >
          <form
          ...
          >
            <input
              ...
              className={
                search
                  ? "upperHero--input upperHero--input__mobile"
                  : "upperHero--input"
              }
              value={search}
              ...
              autoFocus
            />
            <span className="material-symbols-outlined upperHero--icon">
              search
            </span>
          </form>
        ...
        <div className="lowerHero--topBreed__container">
          ...
          <Link to="/popular-breed">
            <p className="showMore--text">
              see more
              <span className="material-symbols-outlined showMore--icon">
                trending_flat
              </span>
            </p>
          </Link>
